...
animals <- read_parquet("C:/Users/srmh0/OneDrive/Documents/GitHub/2025_fall_posit_course/data/intermediate_files/animals.parquet")
...
graph <- ggplot(age_left_1, aes(x = date_left, fill = age_left)) +
  geom_histogram(binwidth = 30, position = "dodge", color = "black") +
  theme_minimal(base_size = 14) +
  labs(
    title = "Animals that have Left Herd over time",
    x = "Date",
    y = "Count",
    fill = "Age"
  )
